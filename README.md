...
* Классы:
    * class Calc (2):
        ...
        * Реализация функций №3-65, отвечающих за элементарные операции (2c);
        * Реализация функций №66-96, отвечающих за элементарные операции (2d);
    * class Program (3);
    * class Buffer (4);
    * class Number (5);
* Backup (6);
...
3. Реализация функций №3-65 должна производиться в файле `CalcExec/calc_operations_c.cpp`, функций №66-96 - в файле `CalcExec/calc_operations_d.cpp`.
